...
class OutlineCrew():
    ...
    @agent
    def outline_maker(self) -> Agent:
        return Agent(
            config=self.agents_config['outline_maker'], # type: ignore[index]
            verbose=True
        )
    ...
    def outline_task(self) -> Task:
        return Task(
            ...
            output_file='output/outline_list.txt'
        )
    ...
    def bias_check_task(self) -> Task:
        return Task(
            ...
            context = [self.outline_task()] # type: ignore[index]
        )
